...
<body>
    <div class="wrapper ">
        <div class="sidebar" data-color="black" data-background-color="blue" data-image="../assets/img/sidebar.jpg">
            <div class="logo bg-primary"><a href="./" class="simple-text logo-normal">
                    Farmacia MediExpress
                </a></div>
            <div class="sidebar-wrapper">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex" href="productos_listado.php">
                            <i class="fab fa-product-hunt mr-2 fa-2x"></i>
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Sistema de Gestion de Ventas</a>
                    </div>
