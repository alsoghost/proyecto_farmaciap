                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="codigo" class=" text-dark font-weight-bold"><i class="fas fa-barcode"></i> Cod. Producto</label>
                                        <input type="text" placeholder="Ingrese código de barras" name="codigo" id="codigo" class="form-control" maxlength="3">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" placeholder="Ingrese cantidad" class="form-control" name="cantidad" id="cantidad" min="1" max="999" >
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
